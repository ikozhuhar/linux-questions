...
_**Ответ**_: Команда `df` показывает свободное и доступное дисковое пространство в системах Linux. Параметр -h показывает объём дискового пространства в формате (МБ и гигабайт). Если вы хотите просмотреть использование диска с более подробной информацией, такой как тип файловой системы и блоки, вы можете использовать команду: `df -Th`.
